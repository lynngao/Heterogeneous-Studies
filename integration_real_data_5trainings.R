...
#command_args <- c("/Users/lynngao/Desktop/abundance_metadata/count_data/centrifuge_count_yu_filtered.rds", 
                  ...
                  #"/Users/lynngao/Desktop/abundance_metadata/count_data/centrifuge_count_thomas_filtered.rds")
...
for (i in 1:30) {
  ...
  rf4 = ml_model(ds4, "rf")
  rf5 = ml_model(ds5, "rf")
  rf1_combat = ml_model(ds1_combat, "rf")
  rf2_combat = ml_model(ds2_combat, "rf")
  rf3_combat = ml_model(ds3_combat, "rf")
  rf4_combat = ml_model(ds4_combat, "rf")
  rf5_combat = ml_model(ds5_combat, "rf")
  ...
  cs_zmat <- CS_zmatrix(n_batch=5, training = list(ds1, ds2, ds3, ds4, ds5), perf_name="mxe", "rf")
  cs_weights_seq <- CS_weight(cs_zmat)
  pred_cs_avg <- pred_mat %*% cs_weights_seq
  
  cs_zmat_combat <- CS_zmatrix(n_batch=5, training = list(ds1_combat, ds2_combat, ds3_combat, ds4_combat, ds5_combat), perf_name="mxe", "rf")
  ...
  reg_ssl_res <- Reg_SSL_pred(n_batch=5, training = list(ds1, ds2, ds3, ds4, ds5), "rf")
  ...
  reg_ssl_res_combat <- Reg_SSL_pred(n_batch=5, training = list(ds1_combat, ds2_combat, ds3_combat, ds4_combat, ds5_combat), "rf")
